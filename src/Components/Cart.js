      ...
      <div className="container">
        <div className="row">
          <div className="col-md-8 mt-5">
            ...
            <div class="form-check">
              <input
                class="form-check-input mt-2 cartCheckBox"
                type="checkbox"
                value=""
                id="flexCheckChecked"
                  ...
                  <div class="dropdown">
                    ...
                    >
                      ...
                      <i
                        ...
                        style={{ olor: "grey", marginLeft: "2px" }}
                      ></i>
                    </button>
          ...
          <div className="col-md-4">
            <div className="card1">
              <div className="card cartPriceCard">
        ...
        <div className="row">
          ...
          <div className="col-lg-4 mt-5">
            <div class="mb-3">
              <select id="disabledSelect" class="form-select">
                <option style={{ color: "grey" }}>Name of Products</option>
          ...
          <div className="col-lg-4 mt-5">
            <div class="mb-3">
              <select id="disabledSelect" class="form-select">
                <option style={{ color: "grey" }}>Number of Users</option>
