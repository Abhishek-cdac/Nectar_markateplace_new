      ...
      <div className='row'>
        <div className='col'>
          ...
          <div className='mx-5 pt-5' >
            ...
            <li>Email notifications, Users can monitor specific task</li>
            <li>Built-in Reporting (reports)</li>
            <li>Creating Filters</li>
            <li>Export to CSV, Microsoft Excel</li>
            <li>Users: Easy, every employees can access it according to his/her defined role</li>
            <li>Views</li>
