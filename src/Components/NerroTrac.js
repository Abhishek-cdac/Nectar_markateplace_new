    ...
    <div className='container pt-5'>
        <div className='row '>
            ...
            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 my-5  " style={{ justifyContent: "right" }}>
                ...
                <button className="btn btn-lg text-white m-2 button-buy" style={{ borderRadius: "2px", background: "#F16728", }}>{buttontext}</button>
                <button className="btn btn-lg text-white m-2 button-free" style={{ borderRadius: "2px", background: "#F16728", }}>{buttontext2}</button>
                </div>
            </div>
        </div>
        </div>
