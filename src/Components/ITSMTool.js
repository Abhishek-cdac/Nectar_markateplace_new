...
function ITSMTool({ title, subtext1, buttontext2, buttontext, heading, item1, item2, item3,item4 }) {
  return (

    <section className='backgroundimage-ITSMTool'>
    <div className='container pt-5'>
        <div className='row '>
            <div className='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
                ...
                <p className='  text-white '> <span className='fa-solid fa-check-double text-white mx-3'></span>{item4}</p>
            </div>
