        ...
        <div>
                ...
                <div className='row pt-2'>
                    <div className='col  text-white pt-5' style={{ background: "#08668F", }}>
                        ...
                        <h6 className='text-center'>nDatu not only allows you to track the progress of task resolution for multiple projects/clients, but it also saves information about all task in a database, allowing you to mine data from past task and projects/clients too.</h6>
                        <div className='row'>
